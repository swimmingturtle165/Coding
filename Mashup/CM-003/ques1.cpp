...
void dfs2(int curr, int parent,int val,vector<ll>& dst)
{
...
signed main(int argc, char** argv)
{
    ...
    while(t--)
    {
        ...
        FORDE(i,n-2,1)
        {
            // cout<<strg[i].s<<" && "<<strg[i].f<<" "<<c<<" "<<c2<<" "<<b<<endl;
            
               ll common=dst[lca(b,strg[i].s)];
               ll left=dst[strg[i].s]-common;
