...
struct segmenttree{
    ...
    ll get_segment(ll idx,ll x,ll lx ,ll rx)
    {
        ...
        // left child             +                        
        return max(segtree[x] , get_segment(idx, 2 * x + 1, lx, mid));
        }
        // right child       
        return max(segtree[x] ,get_segment(idx, 2 * x + 2, mid,rx));
    ...
    void maxi(ll l, ll r,ll v,ll x,ll lx ,ll rx)
    {
        ...
        // left child             +                   
        maxi(l, r, v, 2 * x + 1, lx, mid);
        //  right child
        maxi(l, r, v, 2 * x + 2, mid, rx);


        return;
    }

    void maxi(ll l, ll r,ll v)
    {
        maxi(l, r, v, 0, 0, sz);
    }
};
