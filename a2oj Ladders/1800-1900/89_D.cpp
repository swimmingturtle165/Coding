        ...
        FOR(i,0,n1+1)
        {
            FOR(j,0,n2+1)
            {
                FOR(k,0,g+1)   
                {
                    ...
                    if(k<=k2)
                    {
                        // ADDING A FOOTMAN TO A PLACE WHERE LAST WAS A HORSE
                         dp[i+1][j][1][0] += dp[i][j][0][k];
                    ...
                    if(k+1<=k1 && k>0)
                    {
                    // ADDING A FOOTMAN TO A PLACE WHERE LAST WAS A MAN
                ...
                FOR(k,0,g+1)
                {
                   ...
                   if(k<=k1)
                   {
                    // ADDING  A HORSE TO A PLACE WHERE LAST WAS A MAN
                    ...
                    if(k+1<=k2 && k>0)
                    {
                    // ADDING A HORSE TO A PLACE WHERE LAST WAS A HORSE

                    dp[i][j+1][0][k+1] += dp[i][j][0][k];
                    dp[i][j + 1][0][k+1] %= v3;
                    }
