...
signed main(int argc, char** argv)
{
    ...
    while(t--)
    {
          string str;
        cin>>str;
        ll curr_0=1,curr_1=1,curr_a=1,curr_b=1;
        ll cnt=1;
        ...
        FOR(i,0,n)
        {
            if(str[i]=='&' || str[i]=='|' || str[i]=='^' )
            {
                ...
                if(str[i]=='&')
                {
                    curr_0=(temp_0+temp_1+temp_a+temp_b+temp_1+temp_a+temp_b+temp_a+temp_b)%MOD;
                    curr_1=(temp_1)%MOD;
                    curr_a=(temp_1+temp_a+temp_a)%MOD;
                    curr_b=(temp_1+temp_b+temp_b)%MOD;
                }
                if(str[i]=='|')
                {
                    curr_0=(temp_0)%MOD;
                    curr_a=(temp_0+temp_a+temp_a)%MOD;
                    curr_b=(temp_0+temp_b+temp_b)%MOD;
                    curr_1=(temp_0+2*temp_a+2*temp_b+4*temp_1)%MOD;
                }
                if(str[i]=='^')
                {
                    curr_0=v;
