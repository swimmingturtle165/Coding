...
signed main(int argc, char** argv)
{
    ...
    while(t--)
    {
        ...
        {
            ll ans=0;
            int idx=lower_bound(inp.begin(),inp.end(),x)-inp.begin();
            // element exists or doesn't exist ans=1;
            //    x <= inp[p] => ans + (p-upper_bound(inp,x));
            //    inp[p] < x <inp[k] =>No solution
            //    x>=inp[k]   => No solution
        ...
        {
            // element exists or doesn't exist ans=1
            // x<=inp[k] =>No solution ans+(lower_bound(inp,x)-k);
            // inp[k] <x <inp[p] =>No solution
            // x>=inp[p]  
