...
signed main(int argc, char** argv)
{
    ...
    //  for(int i =0 ; i <n;i++) cout<<arr[i]<<" "<<strg[i]<<endl;
    while(t--)
    {
        int left,right;
        cin>>left>>right;
        ...
        int ans=strg[right]-strg[left];
        ans=ans%2;
       if(ans==0 &&(strg[right]!=strg[left] &&strg[left]!=strg[left+1]) )
       {
           cout<<"YES"<<endl;
       }
       else if(ans==1 &&(strg[left]==strg[left+1] ) )
       {
           cout<<"YES"<<endl;
