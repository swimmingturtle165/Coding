...
void cnt(ll v,ll &curr_a1,ll &curr_a2,ll &curr_a3)
{
...
signed main(int argc, char** argv)
{
    ...
    while(t--)
    {
        ...
        cin>>a1>>a2>>a3;
        ll maxi,mini,mid;
        maxi=max(a1,max(a2,a3));
        mini=min(a1,min(a2,a3));
        mid=(a1+a2+a3)-(maxi+mini);
         a1=0,a2=0,a3=1;
         ll ans=0;
         ll cnt=0;
         if(maxi==0)
        ...
        else
        {
            ...
            FOR(i,1,7)
            {
                ll curr_a1=0,curr_a2=0,curr_a3=1;
                ll v=i;
                curr_a3=v%2;
                v=v/2;
                curr_a2=v%2;
                v=v/2;
                curr_a1=v%2;
                if(maxi>=curr_a3 && mid>= curr_a2&&mini>=curr_a1)
                {
                    maxi-=curr_a3;
                    mid-=curr_a2;
                    mini-=curr_a1;
