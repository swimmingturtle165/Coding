...
signed main(int argc, char** argv)
{
    ...
    while(t--)
    {
        ...
        vector<vector<ll>> cnt_lft(n,vector<ll>(m,0));
        vector<vector<ll>> cnt_rgt(n,vector<ll>(m,0));
        vector<vector<ll>> cnt_up(n,vector<ll>(m,0));
        vector<vector<ll>> cnt_down(n,vector<ll>(m,0));
