...
signed main(int argc, char** argv)
{
    ...
    long t=1;
    cin>>t;
    vector<ll> strg(10000000,2),cnt(10000000,2);
    FOR(i,1,10000000){
        strg[i]=strg[i-1]+2+3*i;
        cnt[i]=cnt[i-1]+2+3*i;
    }
    // FOR(i,1,100000){
    //     strg[i]+=strg[i-1];
    ...
    ll n;
    cin>>n;
        ll v1=lower_bound(cnt.begin(),cnt.end(),n)-cnt.begin();
        ll ans=0;
        ll curr=n;
        ...
        // {
        //     ll left=n-cnt[v1-1];
        //     ll ans1=upper_bound(strg.begin(),strg.end(),left)-strg.begin();
        //        cout<<ans1+1<<endl;   
