...
signed main(int argc, char** argv)
{
    ...
    while(t--)
    {
        ...
        for(int i = 0 ; i < str.size() ; i++){
            ...
            int diff=abs(score12-score11);
            if((diff==(score12-score11) && diff>mov11) || (diff==(score11-score12) && diff>mov12)){
                ans=min(ans,i+1);
            }

        }       

        // best prob to 2nd team 
        ...
        for(int i = 0 ; i < str.size() ; i++){
            ...
            int mov_left=9-i;
            int diff=abs(score22-score21);
           if((diff==(score22-score21) && diff>mov21) || (diff==(score21-score22) && diff>mov22)){
                ans=min(ans,i+1);
            }
        }
        cout<<ans<<endl;
