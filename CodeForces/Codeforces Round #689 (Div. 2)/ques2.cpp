...
signed main(int argc, char** argv)
{
    ...
    while(t--)
    {
        ...
        vector < vector<pair<ll, ll>>> strg(n, vector<pair<ll, ll>> (m,{0, 0}));
        FOR(i,0,n)
        {
            FOR(j,1,m)
            {
                if(inp[i][j-1]=='*')
                {
                    strg[i][j].first = strg[i][j - 1].first + 1;
                }
        ...
        FOR(i,0,n)
        {
            FORDE(j,m-2,0)
            {
                if(inp[i][j+1]=='*')
                {
                    strg[i][j].second = strg[i][j + 1].second + 1;
                }
        ...
        FOR(j,0,m)
        {
            ...
            FOR(i,0,n)
            {
                   ...
                   if(inp[i][j]=='.')
                   {
                    ...
                    tmp= min(min(strg[i][j].first, strg[i][j].second)+1,tmp+1);
