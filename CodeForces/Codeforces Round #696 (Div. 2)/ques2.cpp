...
signed main(int argc, char** argv)
{
    ...
    #endif
    FastIO;
    vector<ll> strg=prime_till_N(100001);
    long t=1;
    cin>>t;
    while(t--)
    {
        ll n;
        cin>>n;
        ll v1=lower_bound(strg.begin(),strg.end(),1+n)-strg.begin();
        ll v2=lower_bound(strg.begin(),strg.end(),strg[v1]+n)-strg.begin();
        // cout<<strg[v1]<<" "<<strg[v2]<<endl;
        ll ans=strg[v1]*strg[v2];
        cout<<ans<<endl;
    }
    return 0;
}
