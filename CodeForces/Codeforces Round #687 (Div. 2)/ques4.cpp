...
signed main(int argc, char **argv)
{
    ...
    while (t--)
    {
        ...
        bool flg = false;
        // 2 cases either there are 3 numbers such that their Most Significant Bit is same
        // or there can be max 64 numbers as msp of not more than 2 are same ie
        // 2 log2(10^9)=2*32=64
        ll val = 1;
        ll cnt = 0;
        FOR(i, 0, n)
