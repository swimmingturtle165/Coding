...
template<class T> void dispinpay(T *v, int n){for(int i=0;i<n;i++) cout<<v[i]<<" "; nn;}
template<class T> int sizeofinp(T *v){return sizeof(v)/sizeof(T);}
