...
signed main(int argc, char** argv)
{
    ...
    while(t--)
    {
        ll n;
        cin>>n;
        vector<pair<ll,ll>> strg(n+1,{0,0});
        FOR(i,0,n)
        {
            strg[i].first=i;
            cin>>strg[i].second;
        ...
        ll m;
        cin>>m;
        vector<pair<ll,ll>>strg1(m+1,{0,0});
        FOR(i,0,m)
        {
            strg1[i].first=i;
            cin>>strg1[i].second;
        }
        ll ans1=max(0ll,strg[0].second);
        ll ans2=max(0ll,strg1[0].second);

        FOR(i,0,n)
        {
            strg[i+1].second=strg[i+1].second+strg[i].second;
            ans1=max(strg[i+1].second,ans1);
        }
        FOR(i,0,m)
        {
            strg1[i+1].second=strg1[i+1].second+strg1[i].second;
            ans2=max(strg1[i+1].second,ans2);
        }
        ...
        //     if(i==n)
        //     {
        //         curr_ans+=strg1[j].second-strg1[j+1].second;
        //         j++;
        //     }
        //     else if(j==m)
        //     {
        //         curr_ans+=strg[i].second-strg[i+1].second;
        //         i++;

        //     }
        //     else if(strg[i].second >= strg1[j].second)
        //     {
        //         curr_ans+=strg[i].second-strg[i+1].second;
        //         i++;
        //     }
