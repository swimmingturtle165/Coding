...
signed main(int argc, char** argv)
{
    ...
    while(t--)
    {
        ...
        reverse(strg1.begin(),strg1.end());
        // ll v4=1;
        // FORDE(i,strg1.size()-1,0)
        // {
        //     strg1[i].s=v4;
        //     v4++;
        // }
        // FOR(i,0,strg1.size()) cout<<strg1[i].f<<" "<<strg1[i].s<< endl;
        ...
        while(q--)
        {
            ...
            while(strg1[idx].s!=col)
            {
                idx--;
            }
            cout<<strg1[idx].f<<" ";

            FOR(i,idx+1,strg1.size())
            {
                strg1[i].f++;
                swap(strg1[i],strg1[i-1]);    
            }
            strg1[strg1.size()-1]={1,col};
        //    FOR(i,0,strg1.size()) cout<<strg1[i].f<<" "<<strg1[i].s<< endl;
