...
signed main(int argc, char** argv)
{
    ...
    //    vector<vector<ll>> inp(n,vector<ll>(3));
       ...
       map<pair<ll,ll>,ll> strg;
       FOR(i,0,n)
       {
           ll v1,v2;
           cin>>v1>>v2;
           inp[i].first=max(v1,v2);
           inp[i].second=min(v1,v2);
           strg[inp[i]]=i+1;
       } 
        vector<pair<ll,ll>> strg2=inp;
       ...
       vector<ll> strg3(n+1,-1);
       FOR(i,0,n)
       {
           ll idx1=upper_bound(inp.begin(),inp.end(),strg2[i])-inp.begin();
           if(idx1!=n)
           {
               strg3[strg[inp[idx1]]]=i+1;
           }
