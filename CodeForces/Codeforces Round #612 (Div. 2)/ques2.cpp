...
signed main(int argc, char** argv)
{
    ...
    while(t--)
    {
        ...
        ll best_pos1=0,best_pos2=0;
        
       
         sum=0;
        FOR(i,0,n-1)
        {
            sum=max(abs((inp[i+1]==-1?v:inp[i+1])-(inp[i]==-1?v:inp[i])),sum);
        }
        best_pos1=sum,best_pos2=v;

        
        cout<<best_pos1<<" "<<best_pos2<<endl;
    }
    return 0;
}
