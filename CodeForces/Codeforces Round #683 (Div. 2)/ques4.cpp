...
signed main(int argc, char** argv)
{
    ...
    while(t--)
    {
        ...
        vector<vector<vector<int>>> dp(2, vector<vector<int>>(m + 1, vector<int>(3, 0)));
        ...
        FOR(i,0,n)
        {
            FOR(j,0,m)
            {
                if(a[i]==b[j])
                {
                    ...
                    if(dp[1][j+1][2]==1)
                    {
                        // if first match or all existing are gone
                        dp[1][j + 1][0] = i;
                        dp[1][j + 1][1] = j;

                    }
                    ll curr = (4 * dp[1][j + 1][2] - (i + 1 - dp[1][j + 1][0]) - (j + 1 - dp[1][j + 1][1]));
                    if(curr<2)
                    {
                        // if substring starting from here are better than previous starting pts
                        dp[1][j + 1][0] = i;
                        dp[1][j + 1][1] = j;
                        dp[1][j + 1][2] = 1;
                        curr = 2;
                ...
                else
                {
                        ...
                        ll curr1 = (4*dp[1][j][2] - (i + 1  - dp[1][j][0]) - (j + 1 - dp[1][j][1]));
                        ll curr2 = (4*dp[0][j+1][2] - (i + 1 - dp[0][j + 1][0]) - (j + 1 - dp[0][j + 1][1]));
                        if(curr1<=0 && curr2<=0)
                        {
                            dp[1][j + 1][0] = i;
                            dp[1][j + 1][1] = j;
