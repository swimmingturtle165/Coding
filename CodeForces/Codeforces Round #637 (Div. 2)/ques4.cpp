...
signed main(int argc, char** argv)
{
    ...
    while(t--)
    {
        ...
        ll n,k;
        cin>>n>>k;
        vector<string> strg={"1110111", "0010010", "1011101", "1011011", "0111010", "1101011", "1101111", "1010010", "1111111", "1111011"};
        vector<string> inp(n);
        vector<int> ans(n,-1);
        FOR(i,0,n) 
        {
        ...
        FORDE(i,n-1,0)
        {
                        ...
                        FORDE(j,9,0)
                        {
                            ...
                            FOR(k,0,7)
                            {
                                if(inp[i][k]=='1' && strg[j][k]=='0')
                                {
                                    flg=false;
                                    break;
                                }
                                else if(inp[i][k]=='0' && strg[j][k]=='1')
                                {
                                    cost++;
                                }
                            }
                        ...
                        FORDE(j,9,0)
                                {
                                    ...
                                    {   
                                        ...
                                        if(curr>=cost && dp[n-i-1][curr-cost])
                                        {
                                            ans[i]=j;
                                            curr-=cost;
                                            break;
