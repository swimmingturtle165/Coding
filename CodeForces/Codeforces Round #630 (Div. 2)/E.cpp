...
signed main(int argc, char** argv)
{
    ...
    while(t--)
    {
        ...
        if((n*m)%2==1)
        {
            ...
            ll v=(n*m);
            opt++;
            cout<<ntopowermandMod(opt,v,MOD)<<endl;
        }
        else
        {
            ll even,odd;
            ...
            ll v=(ntopowermandMod((opt+1),(n*m),998244353ll)+ntopowermandMod((even-odd),(n*m),998244353ll));
            cout<<(v*modInverse(2,MOD))%MOD<<endl;
        }
