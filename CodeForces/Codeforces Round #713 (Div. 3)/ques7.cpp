...
signed main(int argc, char** argv)
{
    ...
    while(t--)
    {
        ...
        ll ans=1;
        bool flg=true;
        // vector<int> tmp=getFactorization(n);
        // ll i=0;
        // while (i<tmp.size())
        // {
        //     ll val=tmp[i];
        //     ll occ=0;
        //     while (i<tmp.size() && tmp[i]==val )
        //     {
        //         occ++;
        //         i++;
        //     }
        //     // cout<<val<<" "<<occ<<endl;
        //     val=power(val,occ,MOD);
        //     // cout<<val<<" "<<occ<<endl;

        //     if(strg.find(val)==strg.end())
        //     {
        //         flg=false;
        //         break;
        //     }
        ...
        // for(auto it:strg.rbegin() ; it!=strg.rend(): it++)
            ...
            ll v1= it->first;
            ll v2=it->second.first;
            ll v3=it->second.second;
            if(n%v1==0 && (n/v1)%v1!=0)
            {
            //   cout<<v1<<" "<<v2<<" "<<v3<<endl;
                ans*=power(v2,v3,MOD);
