...
signed main(int argc, char** argv)
{
    ...
    long t=1;
    cin>>t;
    vector<int> strg(20000001,-1);
    vector<int> cnt(20000001,-1);

    FOR(i,2,20000001)
    {
        if(strg[i]==-1)
        {
            for(ll k=i;k<20000001;k+=i)
            {
                strg[k]=i;
            }
        }
        ...
        {   
                if(x%i==0)
                {
                    ...
                    if(v2%v3==0)
                    {
                        ...
                        ll k1=power(2,cnt[v2/v3],MOD);
                        // cout<<k1<<" %% "<<i<<" "<<v2/v3<<" "<<strg2[v2/v3]<<endl;
                        ans+=k1;
                    ...
                    if(v2%v3==0 && i1!=i)
                    {
                       ...
                       ll k1=power(2,cnt[v2/v3],MOD);
                        // cout<<k1<<" %% "<<i1<<" "<<v2/v3<<" "<<strg2[v2/v3]<<endl;
                        ans+=k1;
