...
signed main(int argc, char** argv)
{
    ...
    while(t--)
    {
        ...
        cin>>n;
        vector<ll> a(n),b(n);
        ll cnt_1_a=0,cnt_neg_a=0;
        ll cnt_1_b=0,cnt_neg_b=0;

        bool flg_inc=false,flg_dec=false;
        bool help_inc=false,help_dec=false;
        FOR(i,0,n) cin>>a[i];
        FOR(i,0,n) cin>>b[i]; 
        bool flg=true;
        ...
        FOR(i,0,n)
        {
            ...
            if(flg_inc &&!(help_inc || (cnt_1_a>0 &&help_dec)))
            {   
                flg=false;
            }
            if(flg_dec &&!(help_dec ||(cnt_neg_a>0 &&help_inc)))
            {
                flg=false;
            }
            if(a[i]==1 )
