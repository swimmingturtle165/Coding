...
signed main(int argc, char** argv)
{
    ...
    while(t--)
    {
        ...
        FOR(i,1,2*a+1)
        {
            ...
            {
                ll temp_b=j*curr;
                ll pos_c1=temp_b*(c/temp_b);
                ll pos_c2=pos_c1+temp_b;
                ll sd;
                if(c-pos_c1>pos_c2-c)
                {
                    sd=pos_c2;
                }
                else
                ...
                ll cst=abs(i-a)+abs(temp_b-b)+abs(c-sd);
                if(cst<mini)
                {
                    mini=cst;
                    curr_a=i;
        ...
        cout<<mini<<endl;
        cout<<curr_a<<" "<<curr_b<<" "<<curr_c<<endl;
    }
    return 0;
}
