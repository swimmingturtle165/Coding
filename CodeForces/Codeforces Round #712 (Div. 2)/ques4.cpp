...
signed main(int argc, char** argv)
{
    ...
    while(t--)
    {
        ...
        while (mov<n*n)
        {
            ll col;
            cin>>col;
            if(col==1 && strg2.size()>0)
            {
                pll crr=*strg2.begin();
                strg2.erase(crr);
                cout<<2<<" "<<crr.first+1<<" "<<crr.second+1<<endl;
                 
            }
            else if(col==1 && strg1.size()>0)
            {
                pll crr=*strg1.begin();
                strg1.erase(crr);
                cout<<3<<" "<<crr.first+1<<" "<<crr.second+1<<endl;
            }
            else if(col==2 && strg1.size()>0)
            {
                pll crr=*strg1.begin();
                strg1.erase(crr);
                cout<<1<<" "<<crr.first+1<<" "<<crr.second+1<<endl;
            }
            else if(col==2 && strg2.size()>0)
            {
                pll crr=*strg2.begin();
                strg2.erase(crr);
                cout<<3<<" "<<crr.first+1<<" "<<crr.second+1<<endl;
            }
            else if(strg1.size()>0)
            {
                pll crr=*strg1.begin();
                strg1.erase(crr);
                cout<<1<<" "<<crr.first+1<<" "<<crr.second+1<<endl;
            }
            else if(strg2.size()>0)
            {
                pll crr=*strg2.begin();
                strg2.erase(crr);
                cout<<2<<" "<<crr.first+1<<" "<<crr.second+1<<endl;
